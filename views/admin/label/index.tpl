            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title">
                        <a href="/adminArticleLabelAdd" type="button" class="btn btn-success">添加标签</a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="panel panel-default">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>{{.UpdateAt}}</td>
                                <td>
                                    <a class="btn btn-xs btn-info" href="/adminArticleLabelEdit?id={{.Id}}">
                                        编辑
                                    </a>
    ...
    layui.use('laypage', function () {
        ...
        laypage.render({
            ...
            , jump: function (obj, first) {
                ...
                //首次不执行
                if (!first) {
                    window.location.href = "/adminArticleLabelList?page=" + obj.curr
                }
            }
        });
    });
...
<script type="application/javascript">
    ...
    function updateStatusToOpen(id) {
        var sureUpdateStatusToOpen = confirm("你确定启用标签？");
        if (sureUpdateStatusToOpen === false) {
            alert("请确认后再重新提交");
            return false;
        }
        //
        var ajaxActionUrl = '/adminArticleLabelUpdateStatus';
        /* ajax提交 */
        $.ajax({
            //提交数据的类型 POST GET
            type: "POST",
    ...
    function updateStatusToClose(id) {
        var sureUpdateStatusToClose = confirm("你确定禁用标签？");
    ...
    function deleteData(id) {
        ...
        //
        var ajaxActionUrl = '/adminArticleLabelDelete';
        /* ajax提交 */
        $.ajax({
            //提交数据的类型 POST GET
            type: "POST",
